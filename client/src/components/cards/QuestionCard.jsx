...
import AiResponsePreview from '../../pages/interviewPrep/components/AiResponsePrewiew';
                ...
                <div className='flex items-start justify-between cursor-pointer'>
                    <div className='flex items-start gap-3.5'>
                        ...
                        <h3 className='text-xs md:text-[14px] font-medium text-gray-800 mr-0 md:mr-20'
                            onClick={toggleExpland}>{question}</h3>
                    </div>
                    ...
                    <div className='flex items-center justify-end ml-4 relative'>
                        ...
                        <button className='text-gray-400 hover:text-gray-500 cursor-pointer'
                            onClick={toggleExpland}>
                            <LuChevronDown
                                size={20}
                                className={`transform transition-transform duration-300 ${isExpanded ? "rotate-100" : ""}`}
                            />
                        </button>
                    </div>
                </div>
