            ...
            <div className='text-[14px] prose prose-slate dark:prose-invert max-w-none'>
                <ReactMarkdown
                    ...
                    components={{
                        ...
                        a({ children, href }) {
                            return <a className='text-blue-600 hover:underline' href={href} target='_blank' rel='noopener noreferrer'>{children}</a>
                        },
                        table({ children }) {
                            return (
...
function CodeBlock({ code, language }) {
    ...
    return (
        <div className='relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200'>
            ...
            <pre className='text-sm p-4 overflow-x-auto bg-white'>
